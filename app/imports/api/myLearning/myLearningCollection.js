...
class myLearningCollection extends BaseCollection {
  constructor() {
    super('myLearningCollection', new SimpleSchema({}));
  }
 ...
 * @type {myLearningCollection}
 */
export const myLearningCollection = new myLearningCollection();
